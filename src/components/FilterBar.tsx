...
const SELECT_CLASS = "rounded border border-icon-border bg-icon-surface px-3 py-1.5 text-sm text-icon-text";
...
export function FilterBar({
  ...
  return (
    <form className="flex flex-wrap items-end gap-3 rounded-lg border border-icon-border p-4" action="/" method="GET">
      ...
      <div className="flex flex-col gap-1">
        <label className="text-xs uppercase text-icon-text-light">Tier</label>
      ...
      <div className="flex flex-col gap-1">
        <label className="text-xs uppercase text-icon-text-light">Status</label>
      ...
      <div className="flex flex-col gap-1">
        <label className="text-xs uppercase text-icon-text-light">From</label>
        <input type="date" name="from" defaultValue={filters.from ?? ""} className={SELECT_CLASS} />
      </div>
      <div className="flex flex-col gap-1">
        <label className="text-xs uppercase text-icon-text-light">To</label>
        <input type="date" name="to" defaultValue={filters.to ?? ""} className={SELECT_CLASS} />
      </div>
      <div className="flex flex-1 min-w-[200px] flex-col gap-1">
        <label className="text-xs uppercase text-icon-text-light">Search</label>
        <input
          type="text"
          name="q"
      ...
      <a href="/" className="text-sm text-icon-text-light hover:text-icon-text">
        Clear
      </a>
    </form>
  );
